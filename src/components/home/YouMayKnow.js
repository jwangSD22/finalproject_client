...
<div key={user._id} className='d-flex btn' onClick={()=>{linkHandler(user.username)}}>
    <div className='mx-2'><img style={inlineImgStyling} src={user.profilePhotoURL==='NO PROFILE PHOTO'?emptyAvatar:user.profilePhotoURL}></img></div>
